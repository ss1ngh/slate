...
export type ShapeType = 'rect' | 'circle' | 'line' | 'arrow' | 'pencil' | 'select' | 'hand' | 'eraser' | 'diamond' | 'group';
...
export type Shape = RectShape | DiamondShape | CircleShape | LineShape | PencilShape | GroupShape;
